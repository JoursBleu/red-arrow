...
Source: "scripts\control-center-hidden.vbs"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\Red Arrow"; Filename: "{sys}\wscript.exe"; Parameters: """{app}\control-center-hidden.vbs"""; WorkingDir: "{app}"; IconFilename: "{app}\red-arrow.ico"
Name: "{autodesktop}\Red Arrow"; Filename: "{sys}\wscript.exe"; Parameters: """{app}\control-center-hidden.vbs"""; WorkingDir: "{app}"; IconFilename: "{app}\red-arrow.ico"
...
[Run]
Filename: "{sys}\wscript.exe"; Parameters: """{app}\control-center-hidden.vbs"""; Description: "Open {#MyAppName}"; Flags: nowait postinstall skipifsilent runasoriginaluser
